        ...
        <li style={{marginTop:"8px"}}>
          <div class="main" style={{padding:"0px"}}>
            ...
            <button class="fluid ui button" id ="menubtn" style={{margin:"0px",width:"100%"}}>New Enter</button>
                ...
                */}
                <div  style={{marginLeft:"10%", marginRight:"-1%", marginTop:"1%", padding:"7px"}}>
                ...
                <div style={{marginRight:"5%"}}>
                    ...
                    <div style={{backgroundColor:"#d2d0cd",padding:"10px",textAlign:"center",width:"80%",height:"113px"}}>
                    ...
                    <div style={{marginRight:"20px"}}>
                      ...
                      {doct && doct.map(doct => ( 
                      <div index={index++} value={props.data.label} hidden={(index )!= props.data.label}>
                    <input type="text" id="fname" name="name" value={doct.name} onChange={nameChange}  placeholder="Name" />
                    <input type="text" id="fname" name="name" value={doct.facebook_page} onChange={facebookChange}  placeholder="Facebook" />
                    <input type="text" id="fname" name="name"  value={doct.youtube_channel}  onChange={youtubeChange}  placeholder="YouTube" />
                    <input type="text" id="fname" name="name"  value={doct.twitter_username} onChange={twitterChange}  placeholder="Twitter" />

...
import useFirestorenews from './useFirestorenews.js';
       ...
       <div >
        ...
        <div className="field">
                            ...
                            <div className="control">
                                <input id="fname"  style={{background:"transparent"}}   placeholder={newsdata.imagetitle} 
                                    autoComplete="off"
